...
# Plugins to try later: 1password chezmoi fasd golang poetry pylint python common-aliases
plugins=(colored-man-pages docker git git-auto-fetch git-commit helm kubectl ssh sudo tmux zsh-completions zsh-autosuggestions docker-compose alias-finder colorize zsh-vi-mode)
...
# Use vscode existing window for kubectl edit
export KUBE_EDITOR="code --wait -r"

# To be able to run krew kubectl plugins
...
# Autocompletion for ddtool
source "$(brew --prefix)/share/zsh/site-functions/_ddtool"

eval "$(zoxide init zsh)"

# Created by `pipx` on 2025-05-29 20:49:29
export PATH="$PATH:/Users/matthieu.neau/.local/bin"
